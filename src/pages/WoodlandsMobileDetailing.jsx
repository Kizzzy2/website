...
export default function WoodlandsMobileDetailing() {
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Professional mobile auto detailing in The Woodlands TX. Full detail from $250, ceramic coating from $800. Serving Carlton Woods, Panther Creek, Hughes Landing — we come to your home." />
      ...
      <section className="location-hero">
        ...
        <div className="container">
          ...
          <div className="hero-btns">
            <a href="/pricing#book" className="btn-primary">Book in The Woodlands</a>
