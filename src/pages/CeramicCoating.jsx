      ...
      <section className="page-hero" style={{ backgroundImage: `url(${img.ceramicVette})` }}>
        ...
        <div className="container">
          ...
          <div className="hero-btns">
            <a href="/pricing" target="_blank" rel="noopener" className="btn-primary">Get a Free Quote</a>
        ...
        <div className="container">
          ...
          <div className="packages-grid">
            <div className="package-card">
              ...
              <a href="/pricing" target="_blank" rel="noopener" className="btn-outline">Get a Quote</a>
            </div>
            <div className="package-card featured">
              ...
              <a href="/pricing" target="_blank" rel="noopener" className="btn-primary">Get a Quote</a>
            </div>
            <div className="package-card">
              <h3>Elite Ceramic</h3>
