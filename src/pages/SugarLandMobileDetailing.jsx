...
export default function SugarLandMobileDetailing() {
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Professional mobile auto detailing in Sugar Land TX. Full detail from $250, ceramic coating from $800. Serving First Colony, New Territory, Riverstone, and all of Sugar Land — we come to you." />
